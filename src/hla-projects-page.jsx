...
import { getProjectFeatures } from "./api/api";
import {
  Menu,
  X,
  ChevronDown,
...
const HLAProjectsPage = () => {
  // Get projects using the custom hook first
  ...
  useEffect(() => {
    if (selectedProject) {
      //setSelectedImage(
      //  selectedProject.featured_image_url || selectedProject.images[0]?.url
      //);
  ...
  const fetchProjectFeatures = async () => {
    ...
    try {
      const features = await getProjectFeatures(selectedProject.id);
  ...
  // Get available years
  const availableYears = ["All", ...new Set(projects.map((p) => p.year))].sort(
    (a, b) => {
      if (a === "All") return -1;
      if (b === "All") return 1;
          ...
          {isMenuOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
                ...
                <a
                  href="#projects"
                  className="block px-3 py-2 text-[#2D5A3D] font-medium"
                >
                  Projects
                </a>
                <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Explore our diverse portfolio of architectural excellence, from
              sustainable homes to innovative commercial spaces. Each project
              reflects our commitment to beautiful, functional design.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Select a category to explore specific types of projects
            </p>
          </div>
            ...
            {Object.entries(categories).map(([key, category]) => (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div
                    className={`w-12 h-12 mb-4 rounded-lg flex items-center justify-center transition-colors ${
                      selectedCategory === key
                        ? "bg-white/20"
                        : "bg-gray-50 group-hover:bg-[#2D5A3D]/10"
                    }`}
                  >
                  ...
                  <div
                    className={`w-full h-0.5 rounded ${
                      selectedCategory === key
                        ? "bg-white/30"
                        : "bg-gray-200 group-hover:bg-[#2D5A3D]/20"
                    }`}
                  ></div>
                </div>
              </button>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 leading-relaxed">
            ...
            with our proven expertise and commitment to sustainable, beautiful
            design.
          </p>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl w-full max-w-7xl max-h-[90vh] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="h-full flex flex-col lg:flex-row">
              ...
              {/* Project Details Sidebar - Full height with overflow-y-auto */}
              <div className="lg:w-96 bg-white flex-1 overflow-y-auto">
                    ...
                    {isFeaturesLoading ? (
                      ...
                      <div className="flex flex-wrap gap-2">
                        {features.map((feature, index) => (
                          <div
                            key={index}
                            className="bg-gray-100 text-gray-700 px-3 py-2 rounded-lg flex flex-col gap-1"
                          >
